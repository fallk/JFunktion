...
/**
 * Represents a consumer of a {@code int}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface IntCharBooleanBooleanConsumer {
     ...
     */
    void apply(int v, char v2, boolean v3, boolean v4);
}
