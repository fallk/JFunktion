...
/**
 * Represents a consumer of a {@code long}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface LongCharBooleanBooleanConsumer {
     ...
     */
    void apply(long v, char v2, boolean v3, boolean v4);
}
