...
/**
 * Represents a consumer of a {@code boolean}-valued and a {@code float}-valued argument.
 ...
 */
@FunctionalInterface
public interface BooleanFloatBooleanBooleanConsumer {
     ...
     */
    void apply(boolean v, float v2, boolean v3, boolean v4);
}
