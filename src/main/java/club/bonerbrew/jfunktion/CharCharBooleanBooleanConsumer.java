...
/**
 * Represents a consumer of a {@code char}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface CharCharBooleanBooleanConsumer {
     ...
     */
    void apply(char v, char v2, boolean v3, boolean v4);
}
