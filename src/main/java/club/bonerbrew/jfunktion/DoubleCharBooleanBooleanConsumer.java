...
/**
 * Represents a consumer of a {@code double}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface DoubleCharBooleanBooleanConsumer {
     ...
     */
    void apply(double v, char v2, boolean v3, boolean v4);
}
