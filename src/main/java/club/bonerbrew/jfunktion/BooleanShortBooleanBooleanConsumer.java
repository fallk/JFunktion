...
/**
 * Represents a consumer of a {@code boolean}-valued and a {@code short}-valued argument.
 ...
 */
@FunctionalInterface
public interface BooleanShortBooleanBooleanConsumer {
     ...
     */
    void apply(boolean v, short v2, boolean v3, boolean v4);
}
