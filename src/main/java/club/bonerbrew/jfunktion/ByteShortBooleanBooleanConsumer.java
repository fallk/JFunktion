...
/**
 * Represents a consumer of a {@code byte}-valued and a {@code short}-valued argument.
 ...
 */
@FunctionalInterface
public interface ByteShortBooleanBooleanConsumer {
     ...
     */
    void apply(byte v, short v2, boolean v3, boolean v4);
}
