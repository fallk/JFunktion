...
/**
 * Represents a consumer of a {@code float}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface FloatCharBooleanBooleanConsumer {
     ...
     */
    void apply(float v, char v2, boolean v3, boolean v4);
}
