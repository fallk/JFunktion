...
/**
 * Represents a consumer of a {@code boolean}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface BooleanCharBooleanBooleanConsumer {
     ...
     */
    void apply(boolean v, char v2, boolean v3, boolean v4);
}
