...
/**
 * Represents a consumer of a {@code short}-valued and a {@code int}-valued argument.
 ...
 */
@FunctionalInterface
public interface ShortIntBooleanBooleanConsumer {
     ...
     */
    void apply(short v, int v2, boolean v3, boolean v4);
}
