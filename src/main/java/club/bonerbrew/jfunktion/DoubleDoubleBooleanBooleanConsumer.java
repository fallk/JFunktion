...
/**
 * Represents a consumer of a {@code double}-valued and a {@code double}-valued argument.
 ...
 */
@FunctionalInterface
public interface DoubleDoubleBooleanBooleanConsumer {
     ...
     */
    void apply(double v, double v2, boolean v3, boolean v4);
}
