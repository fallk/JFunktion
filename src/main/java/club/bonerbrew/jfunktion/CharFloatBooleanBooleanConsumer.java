...
/**
 * Represents a consumer of a {@code char}-valued and a {@code float}-valued argument.
 ...
 */
@FunctionalInterface
public interface CharFloatBooleanBooleanConsumer {
     ...
     */
    void apply(char v, float v2, boolean v3, boolean v4);
}
