...
/**
 * Represents a consumer of a {@code float}-valued and a {@code long}-valued argument.
 ...
 */
@FunctionalInterface
public interface FloatLongBooleanBooleanConsumer {
     ...
     */
    void apply(float v, long v2, boolean v3, boolean v4);
}
