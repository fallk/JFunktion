...
/**
 * Represents a consumer of a {@code short}-valued and a {@code char}-valued argument.
 ...
 */
@FunctionalInterface
public interface ShortCharBooleanBooleanConsumer {
     ...
     */
    void apply(short v, char v2, boolean v3, boolean v4);
}
