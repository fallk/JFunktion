...
/**
 * Represents a consumer of a {@code char}-valued and a {@code double}-valued argument.
 ...
 */
@FunctionalInterface
public interface CharDoubleBooleanBooleanConsumer {
     ...
     */
    void apply(char v, double v2, boolean v3, boolean v4);
}
