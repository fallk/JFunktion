...
/**
 * Represents a consumer of a {@code float}-valued and a {@code int}-valued argument.
 ...
 */
@FunctionalInterface
public interface FloatIntBooleanBooleanConsumer {
     ...
     */
    void apply(float v, int v2, boolean v3, boolean v4);
}
