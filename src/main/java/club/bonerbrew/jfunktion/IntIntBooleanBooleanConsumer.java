...
/**
 * Represents a consumer of a {@code int}-valued and a {@code int}-valued argument.
 ...
 */
@FunctionalInterface
public interface IntIntBooleanBooleanConsumer {
     ...
     */
    void apply(int v, int v2, boolean v3, boolean v4);
}
