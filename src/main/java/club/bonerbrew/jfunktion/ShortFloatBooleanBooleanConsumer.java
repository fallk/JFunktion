...
/**
 * Represents a consumer of a {@code short}-valued and a {@code float}-valued argument.
 ...
 */
@FunctionalInterface
public interface ShortFloatBooleanBooleanConsumer {
     ...
     */
    void apply(short v, float v2, boolean v3, boolean v4);
}
