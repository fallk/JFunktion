...
/**
 * Represents a consumer of a {@code boolean}-valued and a {@code byte}-valued argument.
 ...
 */
@FunctionalInterface
public interface BooleanByteBooleanBooleanConsumer {
     ...
     */
    void apply(boolean v, byte v2, boolean v3, boolean v4);
}
