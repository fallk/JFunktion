...
/**
 * Represents a consumer of a {@code long}-valued and a {@code boolean}-valued argument.
 ...
 */
@FunctionalInterface
public interface LongBooleanBooleanBooleanConsumer {
     ...
     */
    void apply(long v, boolean v2, boolean v3, boolean v4);
}
