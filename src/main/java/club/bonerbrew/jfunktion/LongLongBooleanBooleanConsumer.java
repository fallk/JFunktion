...
/**
 * Represents a consumer of a {@code long}-valued and a {@code long}-valued argument.
 ...
 */
@FunctionalInterface
public interface LongLongBooleanBooleanConsumer {
     ...
     */
    void apply(long v, long v2, boolean v3, boolean v4);
}
