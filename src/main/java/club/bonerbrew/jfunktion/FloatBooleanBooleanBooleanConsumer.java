...
/**
 * Represents a consumer of a {@code float}-valued and a {@code boolean}-valued argument.
 ...
 */
@FunctionalInterface
public interface FloatBooleanBooleanBooleanConsumer {
     ...
     */
    void apply(float v, boolean v2, boolean v3, boolean v4);
}
