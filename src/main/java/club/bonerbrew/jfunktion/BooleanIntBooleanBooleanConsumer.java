...
/**
 * Represents a consumer of a {@code boolean}-valued and a {@code int}-valued argument.
 ...
 */
@FunctionalInterface
public interface BooleanIntBooleanBooleanConsumer {
     ...
     */
    void apply(boolean v, int v2, boolean v3, boolean v4);
}
