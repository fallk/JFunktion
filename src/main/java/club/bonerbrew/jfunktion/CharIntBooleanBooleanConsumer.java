...
/**
 * Represents a consumer of a {@code char}-valued and a {@code int}-valued argument.
 ...
 */
@FunctionalInterface
public interface CharIntBooleanBooleanConsumer {
     ...
     */
    void apply(char v, int v2, boolean v3, boolean v4);
}
