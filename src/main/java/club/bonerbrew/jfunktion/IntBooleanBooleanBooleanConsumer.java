...
/**
 * Represents a consumer of a {@code int}-valued and a {@code boolean}-valued argument.
 ...
 */
@FunctionalInterface
public interface IntBooleanBooleanBooleanConsumer {
     ...
     */
    void apply(int v, boolean v2, boolean v3, boolean v4);
}
