...
/**
 * Represents a consumer of a {@code char}-valued and a {@code short}-valued argument.
 ...
 */
@FunctionalInterface
public interface CharShortBooleanBooleanConsumer {
     ...
     */
    void apply(char v, short v2, boolean v3, boolean v4);
}
