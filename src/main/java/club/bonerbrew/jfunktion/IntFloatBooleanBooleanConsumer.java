...
/**
 * Represents a consumer of a {@code int}-valued and a {@code float}-valued argument.
 ...
 */
@FunctionalInterface
public interface IntFloatBooleanBooleanConsumer {
     ...
     */
    void apply(int v, float v2, boolean v3, boolean v4);
}
