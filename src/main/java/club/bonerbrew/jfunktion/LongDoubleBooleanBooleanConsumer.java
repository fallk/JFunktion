...
/**
 * Represents a consumer of a {@code long}-valued and a {@code double}-valued argument.
 ...
 */
@FunctionalInterface
public interface LongDoubleBooleanBooleanConsumer {
     ...
     */
    void apply(long v, double v2, boolean v3, boolean v4);
}
