...
/**
 * Represents a consumer of a {@code double}-valued and a {@code byte}-valued argument.
 ...
 */
@FunctionalInterface
public interface DoubleByteBooleanBooleanConsumer {
     ...
     */
    void apply(double v, byte v2, boolean v3, boolean v4);
}
