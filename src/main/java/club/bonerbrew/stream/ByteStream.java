...
import club.bonerbrew.jfunktion.ByteBinaryOperator;
import club.bonerbrew.jfunktion.ByteConsumer;
import club.bonerbrew.jfunktion.ByteFunction;
import club.bonerbrew.jfunktion.ByteObjectConsumer;
import club.bonerbrew.jfunktion.BytePredicate;
import club.bonerbrew.jfunktion.ByteToBooleanFunction;
import club.bonerbrew.jfunktion.ByteToByteFunction;
import club.bonerbrew.jfunktion.ByteToDoubleFunction;
import club.bonerbrew.jfunktion.ByteToLongFunction;
import club.bonerbrew.jfunktion.OptionalByte;
...
/**
 * A sequence of primitive byte-valued elements supporting sequential and parallel
 * aggregate operations.  This is the {@code byte} primitive specialization of
 * {@link Stream}.
 *
 * @author Rafael
 * @since 19/04/2017
...
public class ByteStream implements IntStream {
    ...
    private ByteStream(IntStream impl) {
        this.impl = impl;
    }
    ...
    public static ByteStream empty() {
        return new ByteStream(StreamSupport.intStream(Spliterators.emptyIntSpliterator(), false));
    }
     ...
     */
    public static ByteStream of(byte t) {
        return new ByteStream(IntStream.of(t));
    }
    ...
    public static ByteStream of(byte... values) {
        ...
        return new ByteStream(Arrays.stream(v));
    }

    /**
     * Converts a boxed Stream{@literal <}Byte> to an unboxed ByteStream.
     *
     * @param values the boxed stream
     * @return the new stream
     */
    public static ByteStream of(Stream<Byte> values) {
        return new ByteStream(values.mapToInt(c -> (int) c));
    }

    /**
     * Converts a boxed Iterable{@literal <}Byte> to an unboxed ByteStream.
     *
     * @param values the boxed Iterable
     * @return the new stream
     */
    public static ByteStream of(Iterable<Byte> values) {
        // TODO parallel or nay?
        return new ByteStream(StreamSupport.stream(values.spliterator(), true).mapToInt(c -> (int) c));
    }
     ...
     * @return the new stream
     */
    public ByteStream filter(ByteToBooleanFunction predicate) {
        return new ByteStream(impl.filter(i -> predicate.applyAsBoolean((byte) i)));
    }
     ...
     * @return the new stream
     */
    public ByteStream map(ByteToByteFunction mapper) {
        return new ByteStream(impl.map(i -> mapper.applyAsByte((byte) i)));
    }
    ...
    public <U> Stream<U> mapToObj(ByteFunction<? extends U> mapper) {
        return impl.mapToObj(i -> mapper.apply((byte) i));
    }
    ...
    public LongStream mapToLong(ByteToLongFunction mapper) {
        return impl.mapToLong(i -> mapper.applyAsLong((byte) i));
    }
    ...
    public DoubleStream mapToDouble(ByteToDoubleFunction mapper) {
        return impl.mapToDouble(i -> mapper.applyAsDouble((byte) i));
    }
    ...
    public ByteStream flatMap(ByteFunction<? extends ByteStream> mapper) {
        return new ByteStream(impl.flatMap(v -> mapper.apply((byte) v)));
    }
    ...
    public ByteStream distinct() {
        return new ByteStream(impl.distinct());
    }
    ...
    public ByteStream sorted() {
        return new ByteStream(impl.sorted());
    }
    ...
    public ByteStream peek(ByteConsumer action) {
        return new ByteStream(impl.peek(i -> action.apply((byte) i)));
    }
    ...
    public ByteStream limit(long maxSize) {
        return new ByteStream(impl.limit(maxSize));
    }
    ...
    public void forEach(ByteConsumer action) {
        impl.forEach(i -> action.apply((byte) i));
    }
    ...
    public void forEachOrdered(ByteConsumer action) {
        impl.forEachOrdered(i -> action.apply((byte) i));
    }
     ...
     * @see #average()
     */
    public int reduce(byte identity, ByteBinaryOperator op) {
        return impl.reduce(identity, (a, b) -> op.applyAsByte((byte) a, (byte) b));
    }
    ...
    public OptionalByte reduce(ByteBinaryOperator op) {
        OptionalInt i = impl.reduce((a, b) -> op.applyAsByte((byte) a, (byte) b));
        return i.isPresent() ? OptionalByte.of((byte)i.getAsInt()) : OptionalByte.empty();
    }
    ...
    public <R> R collect(Supplier<R> supplier,
                         ByteObjectConsumer<R> accumulator,
                         BiConsumer<R, R> combiner) {
        return impl.collect(supplier, (a, b) -> accumulator.apply((byte) b, a), combiner);
    }
    ...
    public boolean anyMatch(BytePredicate predicate) {
        return impl.anyMatch(p -> predicate.test((byte) p));
    }
    ...
    public boolean allMatch(BytePredicate predicate) {
        return impl.allMatch(p -> predicate.test((byte) p));
    }
    ...
    public boolean noneMatch(BytePredicate predicate) {
        return impl.noneMatch(p -> predicate.test((byte) p));
    }
     ...
     */
    public OptionalByte findFirstByte() {
     ...
     * @see #findFirst()
     */
    public OptionalByte findAnyByte() {
     ...
     * each boxed to an {@code Integer}
     */
    public Stream<Byte> boxedBytes() {
        return impl.mapToObj(i -> (byte) i);
    }

    public ByteStream sequential() {
        return new ByteStream(impl.sequential());
    }

    public ByteStream parallel() {
        return new ByteStream(impl.parallel());
    }
...
//    Spliterator.OfInt spliterator();
    ...
    public ByteStream onClose(Runnable closeHandler) {
        return new ByteStream(this.impl.onClose(closeHandler));
    }
...
//    }
    ...
    public ByteStream skip(long n) {
        return new ByteStream(this.impl.skip(n));
    }
...
//    public ByteStream parallel() {
//        return new ByteStream(this.impl.parallel());
//    }
    ...
    public ByteStream unordered() {
        return new ByteStream(this.impl.unordered());
    }
...
//    public ByteStream sequential() {
//        return new ByteStream(this.impl.sequential());
//    }
